    ...
    <div class="user-management-container">               
        ...
        <div class="content-card">
            <div class="table-header">
                ...
                <el-button type="primary" @click="handleAdd" :icon="Plus" class="add-button">新增</el-button>
            </div>
            ...
            <el-table :data="data.tableData" stripe border highlight-current-row class="user-table">
                ...
                <el-table-column label="角色" prop="user_type" align="center">
                    <template #default="scope">
                        ...
                        <el-tag type="success" v-else-if="scope.row.user_type === 'class_mgr'">教室管理员</el-tag>
                ...
                <el-table-column label="操作" align="center">
                    <template #default="scope">
                        ...
                        <el-button type="danger" size="small" :icon="Delete"
                            @click="handleDelete(scope.row.user_account)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <!-- 表单对话框 -->
        <el-dialog v-model="data.formVisible" :title="data.isEdit ? '编辑用户信息' : '新增用户信息'" width="500px"
            ...
            >
                ...
                <el-form-item label="账号" prop="account" required>
                    <el-input v-model="data.form.account" placeholder="请输入账号" 
...
import { 
  User, Medal, Search, RefreshRight, Plus, Edit, Delete 
...
// 删除用户
const handleDelete = (userAccount) => { // 参数名改为userAccount，明确含义
...
if (!data.isEdit) {
  ...
  userData.password = data.form.password; // 编辑时输入了新密码才传递
    ...
    if (error.name === 'ValidationError') {
      ...
      ElMessage.error('后端接口错误：' + (error.response.data.message || (data.isEdit ? '更新失败' : '添加失败')));
    } else {
