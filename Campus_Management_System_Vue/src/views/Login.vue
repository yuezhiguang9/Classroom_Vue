	...
	<div class="font-inter bg-gray-50 min-h-screen flex flex-col">
		...
		<main class="flex-grow flex items-center justify-center px-4 py-8">
			<div
				...
				<p class="subtitle text-gray-500 text-center mt-1 mb-8">
					请选择身份并输入账号密码
				</p>
				...
				<div class="identity-grid mb-8">
					<div
						...
						<i
							...
							:class="
								selectedIdentity === 'user' ? 'text-primary' : 'text-gray-500'
							"></i>
...
<script setup>
	...
	import { setToken, setUserInfo, clearAuthInfo } from "@/utils/auth";
	...
	const handleLogin = async () => {
		...
		try {
			clearAuthInfo(); // 导入auth.js中的clearAuthInfo函数
			// 1. 表单验证
			console.log("开始表单验证");
			if (!validateForm()) {
