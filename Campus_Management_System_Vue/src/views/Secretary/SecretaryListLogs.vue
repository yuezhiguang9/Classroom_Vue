              ...
              <div class="filter-form">
                <div class="filter-row">
                  <div class="form-group">
                    ...
                    <select class="form-select" v-model="filter.applyStatus" @change="fetchLogs">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-select" v-model="filter.buildingId" @change="fetchLogs">
                ...
                <div class="filter-row">
                  ...
                  <div class="form-group form-actions">
                    <button type="button" class="btn reset-btn" @click="resetFilter">重置</button>
                    <button type="button" class="btn search-btn" @click="fetchLogs">查询</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card table-card animate-fade-in" style="animation-delay: 0.5s">
              ...
              <table class="data-table">
                ...
                <tbody>
                  ...
                  <tr v-for="(item, index) in logsData" :key="index">
                    ...
                    <td>
                      <button class="btn view-btn" @click="viewDetails(item.applyid)">
                        查看详情
                      </button>
                      <button
            ...
            <div class="pagination" v-if="!loading && pagination.total > 0">
              ...
              <div class="pagination-info">
                ...
                <select class="page-size-select" v-model="pagination.size" @change="changePageSize">
        ...
        <div class="modal-body">
          ...
          <div class="detail-item" v-if="currentDetail.applyStatus !== '待审核'">
            ...
            <span class="detail-value">{{
              formatDateTime(currentDetail.processingTime) || "-"
            }}</span>
          </div>
          <div
            class="detail-item"
            v-if="currentDetail.applyStatus === '已驳回' && currentDetail.rejectReason"
          >
...
<script setup>
  ...
  const fetchStats = async () => {
    try {
      ...
      const errorMsg =
        error.response?.data?.msg || `服务器错误 (${error.response?.status || "未知"})`;
