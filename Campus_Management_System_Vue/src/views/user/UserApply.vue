      ...
      >
        ...
        <el-table-column label="操作" align="center">
          <template #default="scope">
            ...
            <span class="disabled-text" v-else-if="scope.row.can_cancel === 1">
              不可取消
            </span>
            
            <span class="canceled-text" v-else-if="scope.row.can_cancel === 2">
              已取消
            </span>
...
const loadReservationData = () => {
  ...
  axios.get('http://localhost:8080/user/myReservations', {
    headers: getHeaders(),
    params: {
